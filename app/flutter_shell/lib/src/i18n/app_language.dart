...
class AppLanguage {
  ...
  static const _russianStrings = <String, String>{
    ...
    'search.filters.note':
        'Сейчас поиск фильтрует по имени. Фильтры длительности, дат и размера уже есть в интерфейсе и будут подключены к индексированному поиску в следующей версии.',
