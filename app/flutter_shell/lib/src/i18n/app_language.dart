...
class AppLanguage {
  ...
  static const _englishStrings = <String, String>{
    ...
    'settings.progress.autocollapse.seconds':
        'Progress panel auto-collapse, seconds',
    'settings.progress.autocollapse.note':
        'The expanded progress window returns to the round indicator after this delay.',
    'settings.android.lock.resume':
        'Ask for the app password after Android resume',
    'settings.android.permissions.status': 'Granted Android permissions',
    'settings.android.permission.all.files': 'All files access',
    'settings.android.permission.images': 'Images access',
    'settings.android.permission.video': 'Video access',
    'settings.android.permission.audio': 'Audio access',
    ...
    'explorer.open.all.images': 'Open all pictures',
    'explorer.open.all.videos': 'Open all videos',
    'explorer.open.all.audio': 'Open all audio',
    'explorer.open.all.none': 'No matching media files were found.',
    'explorer.send': 'Send',
    ...
    'explorer.open.as': 'Open as',
    'explorer.encrypt.menu': 'Encrypt',
    'explorer.decrypt.menu': 'Decrypt',
    'explorer.folder.container.as': 'As encrypted container from folder',
    'explorer.folder.encrypt.name.short': 'Folder name',
    'explorer.folder.encrypt.files': 'Files in folder',
    'explorer.folder.decrypt.name.short': 'Folder name',
    'explorer.folder.decrypt.files': 'Files',
    'properties.extension.opening': 'Extension opening',
    'properties.open.external': 'External application',
    'properties.open.internal': 'Built-in viewer',
    'ocr.edit': 'Edit',
    'ocr.save.text': 'Save as text file',
    ...
    'security.execute': 'Execute',
    'security.apply': 'Apply permissions',
    'media.pin.topmost': 'Always on top',
    'syntax.highlight.plugin.name': 'Code syntax highlight',
    'path.edit': 'Edit path',
    ...
    'preview.swf.menu': 'SWF touch menu',
    'pdf.preview.unavailable': 'PDF preview is unavailable.',
    'ebook.empty': 'This e-book has no readable text.',
    'reader.empty': 'There is no text to read aloud.',
    'reader.error': 'Reading error:',
  ...
  static const _russianStrings = <String, String>{
    ...
    'settings.progress.autocollapse.seconds':
        'Автосворачивание прогресса, секунд',
    'settings.progress.autocollapse.note':
        'Развернутое окно прогресса вернется в круглый индикатор через это время.',
    'settings.android.lock.resume':
        'Запрашивать пароль после возврата в Android',
    'settings.android.permissions.status': 'Полученные разрешения Android',
    'settings.android.permission.all.files': 'Доступ ко всем файлам',
    'settings.android.permission.images': 'Доступ к изображениям',
    'settings.android.permission.video': 'Доступ к видео',
    'settings.android.permission.audio': 'Доступ к аудио',
    ...
    'explorer.folder.encrypt.name': 'Зашифровать имя папки',
    'explorer.folder.decrypt.name': 'Расшифровать имя папки',
    'explorer.open.all.images': 'Открыть все картинки',
    'explorer.open.all.videos': 'Открыть все видео',
    'explorer.open.all.audio': 'Открыть все аудио',
    'explorer.open.all.none': 'Подходящие медиафайлы не найдены.',
    ...
    'explorer.open.as': 'Открыть как',
    'explorer.encrypt.menu': 'Зашифровать',
    'explorer.decrypt.menu': 'Расшифровать',
    'explorer.folder.container.as': 'Как зашифрованный контейнер из папки',
    'explorer.folder.encrypt.name.short': 'Имя папки',
    'explorer.folder.encrypt.files': 'Файлы в папке',
    'explorer.folder.decrypt.name.short': 'Имя папки',
    'explorer.folder.decrypt.files': 'Файлы',
    'properties.extension.opening': 'Открытие расширения',
    'properties.open.external': 'Внешней программой',
    'properties.open.internal': 'Встроенным просмотрщиком',
    'ocr.edit': 'Редактировать',
    'ocr.save.text': 'Сохранить как текстовый файл',
    ...
    'security.execute': 'Выполнение',
    'security.apply': 'Применить права',
    'media.pin.topmost': 'Поверх всех окон',
    'syntax.highlight.plugin.name': 'Подсветка синтаксиса кода',
    'path.edit': 'Изменить путь',
    'path.unavailable': 'Путь недоступен.',
    'path.unavailable.ask':
        'Это расположение сейчас недоступно. Если продолжить, текущая папка может перестать работать. Продолжить?',
    'path.root.unavailable':
        'Root-доступ нельзя запросить из этой desktop-сборки.',
    'search.title': 'Поиск',
    ...
    'filter.duration.min': 'Длительность от, секунд',
    'filter.duration.max': 'Длительность до, секунд',
    'filter.created.from': 'Создан от YYYY-MM-DD',
    'filter.created.to': 'Создан до YYYY-MM-DD',
    'filter.modified.from': 'Изменен от YYYY-MM-DD',
    'filter.modified.to': 'Изменен до YYYY-MM-DD',
    'filter.size.min': 'Размер от, байт',
    'filter.size.max': 'Размер до, байт',
    'selection.count': 'Выделено',
    'selection.all': 'Выделить все',
    'selection.clear': 'Снять выделение',
    'selection.zip': 'Архивировать выделенное в ZIP',
    'selection.zip.local.only':
        'ZIP-операции доступны только для локальных папок.',
    'selection.unsupported.bulk':
        'Это массовое действие недоступно для текущего выделения.',
    'create.folder': 'Папка',
    ...
    'settings.plugins.open.window': 'Открыть окно настройки плагинов',
    'settings.plugins.window.title': 'Настройка плагинов',
    ...
    'preview.swf.menu': 'Сенсорное меню SWF',
    'pdf.preview.unavailable': 'Просмотр PDF недоступен.',
    'ebook.empty': 'В этой электронной книге нет читаемого текста.',
    'reader.empty': 'Нет текста для чтения вслух.',
    'reader.error': 'Ошибка чтения:',
    'reader.fragment': 'Фрагмент',
    'reader.next.file': 'Следующий файл',
